...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">WHAT CUSTOMERS SAYS  ABOUT OUR SERVICES</h1>
            ...
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Recognized</h5>
                        <p class="mb-0">Our pregnancy testing services have been recognized for their accuracy and convenience. Count on us for reliable results and support throughout your pregnancy journey.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Trusted Specialists</h5>
                        <p class="mb-0">Our team consists of experienced professionals committed to delivering accurate and supportive pregnancy testing services.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Affordable Options</h5>
                        <p class="mb-0">We provide affordable and competitive pricing for our pregnancy testing services, making quality healthcare accessible to all.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Continuous Assistance</h5>
                        <p class="mb-0">We offer round-the-clock support for all your pregnancy testing needs.</p>
                    </div>
                </div>
            </div>
        </div>
