...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="appointment.html" class="nav-item nav-link">CONTACT US</a>
    ...
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">OUR SERVICES</h1>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid container-service py-5">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">Trustworthy & Accurate Pregnancy Testing Solutions</h1>
                <p class="mb-5">With a commitment to precise results and supportive guidance, our team ensures peace of mind throughout your pregnancy journey.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Immediate Access</h5>
                        <p class="mb-4">Provides instant access to test results, ensuring quick responses to your pregnancy-related queries and concerns.</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <p class="mb-4">Utilizes tracking technology to monitor the status of your pregnancy test order and provide real-time updates on its delivery.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Efficient Processing</h5>
                        <p class="mb-4">Automates the processing of pregnancy test orders for swift and seamless delivery of results.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Notification System</h5>
                           <p class="mb-4">We send notifications and alerts to keep you informed about your pregnancy test status and any important updates regarding your order.</p>
                        <a class="btn btn-light px-3" href="">Continue<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Optimized Delivery Routes</h5>
                            <p class="mb-4">Utilizes algorithms to calculate the most efficient delivery routes for your pregnancy test orders, ensuring timely and reliable service.</p>
                        <a class="btn btn-light px-3" href="">Continue<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Support Services</h5>
                            <p class="mb-4">Caring for our community's health and well-being, our pregnancy test company proudly offers professional support services tailored to your needs.</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Convenient Ordering</h5>
                            <p class="mb-4">Allows users to request pregnancy tests online through a website or mobile app, providing convenience and accessibility.</p>
                        <a class="btn btn-light px-3" href="">Continue<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Language Options</h5>
                           <p class="mb-4">Provides support for multiple languages to accommodate diverse populations and ensure clear communication during the pregnancy testing process, improving accessibility and inclusivity.</p>
                        <a class="btn btn-light px-3" href="">Continue<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
            </div>
 ...
 */
    ...
    $connection = new mysqli('localhost', 'belyse', '222010101', 'online_pregnancy_test_system', 5306);
    ...
    $sql = "SELECT Comments, Name, Time FROM testimony";
        ...
        echo '<div class="container-fluid testimonial py-5">
                <div class="container pt-5">
                    <div class="row gy-5 gx-0">
                        ...
                        <h1 class="display-6 text-white mb-4">What Our Customers Say About Our Pregnancy Test Services!</h1>
                        <p class="text-white mb-5">At EasyTest, we are dedicated to providing reliable and confidential online pregnancy testing services. Your feedback is essential to us as we continuously work to improve our services and support you through this important time in your life.</p>
                        
                            <a href="testimonial.php" class="btn btn-primary py-3 px-5">More Testimonials</a>
                        </div>
        ...
        while ($row = $result->fetch_assoc()) {
            echo '<div class="testimonial-item">
                        ...
                        <div class="ps-3">
                            ...
                            <span class="text-primary">' . $row['Time'] . '</span>
                        </div>
                    </div>';
        }
