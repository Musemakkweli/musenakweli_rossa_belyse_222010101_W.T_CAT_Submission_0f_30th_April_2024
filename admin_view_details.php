...
$sql = "SELECT Name, Email, Password, AdminID, Role FROM admin WHERE email = ?";
  ...
  <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav">
              <a href="admin_home.html" class="nav-item nav-link active">DASHBOARD</a>
              ...
              <a href="results_form.html" class="nav-item nav-link">GIVE RESULTS</a>
              <a href="admin_comment.html" class="nav-item nav-link">COMMENTS</a>
